...
const TRANSLATIONS = {
  vi: {
    ...
    'login.divider':        'hoặc',
    'login.btn_guest':      'Chơi như khách',
    'login.footer':         'Play3CR · Self-hosted · Dữ liệu lưu cục bộ',
    ...
    'modal.ph_room_name':   'Tùy chọn (để trống tự tạo tên)',
    'modal.board_size':     'Kích thước bàn',
    'modal.special_rules':  'Luật đặc biệt',
    'modal.rule_wall':      'Tường (Wall)',
    'modal.rule_portal':    'Cổng dịch chuyển (Portal)',
    ...
    'room.rule_wall':       'Tường',
    'room.rule_portal':     'Cổng',
